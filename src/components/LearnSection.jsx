  ...
  return (
    <section className='learn'>
      ...
      <p>
        <ol>
          <li>
            Set the starting position: Drag and place the sprite ‘on the stage
            to set its initial position. Click and drag the sprite to position
            it where you want it to start.
          </li>
          <li>
            Add movement blocks: In the block palette on the left side of the
            screen, locate the “Motion” «category. You will find blocks like
            "Move 10 steps,” "Turn 15 degrees” and "Goto x: [ ] y: [ ]
          </li>
          <li>
